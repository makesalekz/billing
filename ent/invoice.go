...
type Invoice struct {
	...
	// TtpSubscriptionID holds the value of the "ttp_subscription_id" field.
	TtpSubscriptionID *string `json:"ttp_subscription_id,omitempty"`
...
func (*Invoice) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case invoice.FieldAppID, invoice.FieldCurrency, invoice.FieldStatus, invoice.FieldExternalTransactionID, invoice.FieldPaymentProvider, invoice.FieldTtpSubscriptionID:
...
func (i *Invoice) assignValues(columns []string, values []any) error {
	...
	for j := range columns {
		...
		case invoice.FieldTtpSubscriptionID:
			if value, ok := values[j].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field ttp_subscription_id", values[j])
			} else if value.Valid {
				i.TtpSubscriptionID = new(string)
				*i.TtpSubscriptionID = value.String
			}
		default:
...
func (i *Invoice) String() string {
	...
	builder.WriteString(", ")
	if v := i.TtpSubscriptionID; v != nil {
		builder.WriteString("ttp_subscription_id=")
		builder.WriteString(*v)
	}
	builder.WriteByte(')')
